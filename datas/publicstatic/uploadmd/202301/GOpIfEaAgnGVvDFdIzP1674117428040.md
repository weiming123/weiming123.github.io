&emsp;&emsp;在百度搜索里面，输入：site::[网站地址]     的方式可以查看网站在百度搜索里面的搜录情况，前面在使用 site::liu_yong.gitee.io 的方式查看自己网站在百度搜索 搜录的情况的时候，发现有很多相同的内容但是链接又不同的情况，然后再研究了下SEO后，发现这种情况会降低自己网站的排名，所以做了下优化。
